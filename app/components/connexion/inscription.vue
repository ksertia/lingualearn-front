    ...
    <div class="mx-auto grid min-h-screen max-w-7xl grid-cols-1 lg:grid-cols-2">
      <div class="px-6 py-10 lg:px-10">
        ...
        <div class="mt-10 max-w-md">
          <h1 class="text-4xl font-semibold tracking-tight">Inscrivez-vous</h1>
          ...
          <!-- <div class="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                <path d="M18.244 2H21l-6.52 7.46L22.5 22h-6.59l-5.16-6.76L4.8 22H2l7.03-8.05L1.5 2h6.76l4.66 6.11L18.244 2Zm-1.16 18h1.83L7.3 3.93H5.33L17.084 20Z"/>
              </svg>
          ...
          <form class="space-y-5" @submit.prevent="onSubmit">
            <div>
              <label for="nom" class="block text-sm font-medium text-white/80">Nom<span class="text-red-400">*</span></label>
              <input
                id="nom"
                v-model="nom"
                type="text"
            ...
            <div>
              <label for="prenom" class="block text-sm font-medium text-white/80">Prénom<span class="text-red-400">*</span></label>
              <input
                id="prenom"
                v-model="prenom"
                type="text"
            ...
            <div>
              <label for="phone" class="block text-sm font-medium text-white/80">Télephone<span class="text-red-400">*</span></label>
              <input
                id="phone"
                v-model="phone"
                type="tel"
                autocomplete="tel"
                placeholder="+226 6 00 00 00 00"
                class="mt-2 w-full rounded-md border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/40 outline-none focus:border-[#2D5BFF] focus:ring-2 focus:ring-[#2D5BFF]/30"
                required
              />
            </div>
