...
class ApiService {
  ...
  // =====================
  async login(credentials: LoginCredentials): Promise<AuthResponse> {
    return await this.api('/api/v1/auth/login', {
      method: 'POST',
      body: credentials
    })
  }
  ...
  async getMe(): Promise<{ data: User }> {
    return await this.api('/api/v1/users/me')
  }
  ...
  // =====================
  async getLearningPaths(): Promise<ApiResponse<LearningPath[]>> {
    return await this.api('/api/v1/learning-paths')
  }

  async getLearningPath(id: string): Promise<ApiResponse<LearningPath>> {
    return await this.api(`/api/v1/learning-paths/${id}`)
  }
  ...
  // =====================
  async getLevels(learningPathId?: string): Promise<ApiResponse<Level[]>> {
    return await this.api('/api/v1/levels', {
      query: learningPathId ? { learningPathId } : {}
    })
  }

  async getLevel(id: string): Promise<ApiResponse<Level>> {
    return await this.api(`/api/v1/levels/${id}`)
  }
  ...
  // =====================
  async getSteps(levelId?: string): Promise<ApiResponse<Step[]>> {
    return await this.api('/api/v1/steps', {
      query: levelId ? { levelId } : {}
    })
  }

  async getStep(id: string): Promise<ApiResponse<Step>> {
    return await this.api(`/api/v1/steps/${id}`)
  }
  ...
  // EXERCISES
  // =====================
  async getExercises(stepId?: string): Promise<ApiResponse<Exercise[]>> {
    return await this.api('/api/v1/exercises', {
      query: stepId ? { stepId } : {}
    })
  }

  async getExercise(id: string): Promise<ApiResponse<Exercise>> {
    return await this.api(`/api/v1/exercises/${id}`)
  }
  ...
  // =====================
  async getCourses(stepId?: string): Promise<ApiResponse<Course[]>> {
    return await this.api('/api/v1/courses', {
      query: stepId ? { stepId } : {}
    })
  }

  async getCourse(id: string): Promise<ApiResponse<Course>> {
    return await this.api(`/api/v1/courses/${id}`)
  }
